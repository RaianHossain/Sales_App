                ...
                <form action="{{ route('profiles.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_address" class="form-control" id="inputAddress" value=""
                                placeholder="Address" value="{{ old('user_address') }}">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">Phone</label>
                            <input type="number" name="user_phone" class="form-control" id="inputAddress2" value=""
                                placeholder="Enter Your Phone Number" value="{{ old('user_phone') }}">
                        </div>
